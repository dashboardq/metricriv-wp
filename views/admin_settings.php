...
<div class="wrap admin_tool_basic_page" id="<?php echo esc_attr($action); ?>_page">
	<h1 class="wp-heading-inline"><?php echo esc_html($title); ?></h1>
        ...
        <p>Choose your settings below. Then create an access key on the <a href="edit.php?post_type=metricriv_key">MetricRiv Key page</a>. Once you have copied the key, you can then use it on <a href="https://www.metricriv.com/number/add" target="_blank">MetricRiv when you add a number.</a></p>
